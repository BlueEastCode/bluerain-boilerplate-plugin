...
Please fill the informations requested OR use one of the following url:
  - Bug report: https://github.com/BlueEastCode/bluerain-boilerplate-plugin/issues/new?template=bug-report.md
  - Feature request: https://github.com/BlueEastCode/bluerain-boilerplate-plugin/issues/new?template=feature-request.md
-->
